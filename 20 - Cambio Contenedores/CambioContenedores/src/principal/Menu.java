...
public class Menu extends javax.swing.JFrame {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        PanelCrear ventana = new PanelCrear(basedatos);
        
        ventana.setPreferredSize(contentPrincipal.getPreferredSize());
        ventana.setSize( contentPrincipal.getSize());
        
        contentPrincipal.removeAll();
        
        contentPrincipal.add(ventana);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        PanelEliminar eliminar = new PanelEliminar(basedatos);
        
        eliminar.setPreferredSize( contentPrincipal.getPreferredSize());
        eliminar.setSize( contentPrincipal.getSize());
        
        contentPrincipal.removeAll();
        contentPrincipal.add(eliminar);
