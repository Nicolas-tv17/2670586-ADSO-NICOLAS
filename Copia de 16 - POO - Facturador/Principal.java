public class Principal{
	public static void main(String[] args) {
		...
		listaUsuarios[5] = new Usuario("109900", "Juan Cardona", "Calle 20", "VENDEDOR");
		listaUsuarios[6] = new Usuario("109901", "Pepito Perez", "Calle 19", "VENDEDOR");
		listaUsuarios[7] = new Usuario("109902", "Sofia Garcia", "Calle 18", "VENDEDOR");
		listaUsuarios[8] = new Usuario("109903", "Catalina Morales", "Calle 17", "VENDEDOR");
		listaUsuarios[9] = new Usuario("109904", "Ana Luna", "Calle 16", "VENDEDOR");
