...
public class EliminarPersona extends javax.swing.JFrame {
    ...
    public EliminarPersona(TablaBotones windo, Persona[] lisPersonas, int posicion) {
    ...
    public void initAlternComponents(){
        ...
        etqPersona.setText(listaPersonas[posicion].getNombres()+);
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        for (int i = 0; posicion < listaPersona.length-1; i++) {
            listaPersona[i] = listaPersona[i+1];
        }
        listaPersona[listaPersona.length-1] = null;
        
        windo.imprimirPersonas();
        dispose();
